...
window.FRAME_REGISTRY = (() => {
	...
	const components = {
		...
		UBLegendCrownsFloating: {slot:'crown-variant', family:'borderless', mode:'select', control:'Legend Crown', default:'Floating Legend Crown', value:'Universes Beyond Legend Crown'},
		...
		ModalLegendCrownsBrawl: {slot:'crown-variant', family:'modal', mode:'select', control:'Variant', default:'Default', value:'Brawl'},
