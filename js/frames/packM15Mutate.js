...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		mutate: {name:'Mutate Cost', text:'Mutate {3} {i}(If you cast this spell for its mutate cost, put it over or under target non-Human creature you own. They mutate into the creature on top plus all abilities from under it.)', x:0.086, y:0.6303, width:0.828, height:0.1215, size:0.0291},
