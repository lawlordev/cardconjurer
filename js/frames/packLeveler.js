...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		levelup: {name:'Level Up', text:'Level up {1} {i}({1}: Put a level counter on this. Level up only as a sorcery.){/i}', x:0.086, y:0.6303, width:0.6834, height:0.0905, size:0.0296},
